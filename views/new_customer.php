...
<html>
  ...
  <?php
    ...
    $current_scheme = $customer_scheme;
    ...
    $counts = $current_scheme->CountRows($conn, 'age');
  ?>
      ...
      <div class="w3-quarter">
        <div class="w3-container w3-blue w3-padding-16">
          ...
          <div class="w3-right">
            <h3>
              <?php
                echo $current_scheme->Average($conn, 'age');
              ?>
            </h3>
          </div>
          <div class="w3-clear"></div>
       ...
       <div class="w3-quarter">
        <div class="w3-container w3-teal w3-padding-16">
          ...
          <div class="w3-right">
            <h3>
              <?php
                echo $current_scheme->CountRows($conn, 'age', ['consumption_state' => '啟用']);
              ?>
            </h3>
          </div>
          <div class="w3-clear"></div>
      ...
      <div class="w3-quarter">
        <div class="w3-container w3-orange w3-text-white w3-padding-16">
          ...
          <div class="w3-right">
            <h3>
              <?php
                echo $current_scheme->CountRows($conn, 'age', ['consumption_state' => '停用']);
              ?>
            </h3>
          </div>
          <div class="w3-clear"></div>
