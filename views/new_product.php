...
<html>
  ...
  <?php
    ...
    $selection = $product_scheme->GetPostValues(true, "%");
    ...
    $results = $product_scheme->Select($conn, $selection, offset: $offset);
  ?>
  ...
  <nav class="w3-sidebar w3-collapse w3-white" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="new_product.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa material-icons fa-fw">widgets</i>  Products</a>
      ...
      <div class="w3-quarter">
        <div class="w3-container w3-red w3-padding-16">
          ...
          <div class="w3-right">
            <h3>
              <?php
                // $product_scheme->CountRows($conn, 'age');
              ?>
            </h3>
          </div>
      ...
      <div class="w3-quarter">
        <div class="w3-container w3-blue w3-padding-16">
          ...
          <div class="w3-right">
            <h3>
              <?php
                // $product_scheme->Average($conn, 'age');
              ?>
            </h3>
          </div>
          <div class="w3-clear"></div>
      ...
      <table class="w3-table w3-striped w3-white" >
        <form method="post" action="" class="form-container">
          ...
          <tr>
            ...
            <?php echo create_inputs($product_scheme, use_default: "post", no_style: false, nullable: true); ?>
          </tr>
        </form>
        <?php
          if(!empty($results))
  ...
  <div class="form-popup" id="update-form-container">
    <form method="post" action="../modules/update.php" class="form-container">
      ...
      <?php echo create_inputs($product_scheme, use_default: "none"); ?>
  ...
  <div class="form-popup" id="insert-form-container">
    <form method="post" action="../modules/insert.php" class="form-container">
      ...
      <?php 
        ...
        echo create_inputs($product_scheme, keys: $input_keys, use_default: "none"); 
      ?>
