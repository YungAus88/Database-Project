      ...
      <table class="w3-table w3-striped w3-white" >
        <form method="post" action="" class="form-container">
          ...
          <tr>
            ...
            <?php echo create_inputs($conn, $product_scheme, use_default: "post", dynamic_width: false, nullable: true); ?>
          </tr>
        </form>
        <?php
          if(!empty($results))
 ...
 -->
  ...
  <div class="form-popup" id="update-form-container">
    <form method="post" action="../modules/update.php" class="form-container">
      ...
      <?php echo create_inputs($conn, $product_scheme, use_default: "none"); ?>
  ...
  <div class="form-popup" id="insert-form-container">
    <form method="post" action="../modules/insert.php" class="form-container">
      ...
      <?php 
        ...
        echo create_inputs($conn, $product_scheme, keys: $input_keys, use_default: "none"); 
      ?>
